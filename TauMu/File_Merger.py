...
try :
	...
	if type_of_run:
		os.system('hadd '+channel_dir+'MC/out/Signal_Sherpa.root NOMINAL/Ztautau_sherpa*.root')
		os.system('hadd '+channel_dir+'MC/out/Signal_PoPy.root NOMINAL/Ztautau_201*.root')
